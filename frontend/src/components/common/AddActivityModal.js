...
const AddActivityModal = ({ isOpen, onClose, onActivityAdded, preselectedWorkPackageId = null }) => {
  const [formData, setFormData] = useState({
    work_package_id: preselectedWorkPackageId || '',
    resource_id: '',
    planned_hours: '',
    start_date: '',
    end_date: ''
  ...
  useEffect(() => {
    if (preselectedWorkPackageId) {
      setFormData(prev => ({ ...prev, work_package_id: preselectedWorkPackageId }));
    }
  }, [preselectedWorkPackageId]);
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="➕ Add New Activity" size="large">
      <form onSubmit={handleSubmit} className="modal-form">
        ...
        <div className="form-group">
          ...
          <select
            ...
            required
            disabled={loading || loadingData || preselectedWorkPackageId}
          >
        ...
        <div className="form-info">
          <strong>⚠️ Important:</strong> The system will validate that the resource has 
          sufficient capacity for the planned hours during this period. Warnings will be 
          shown if the allocation exceeds available capacity.
        </div>
